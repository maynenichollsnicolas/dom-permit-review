...
const en = {
  ...
  domDetail: {
    ...
    roundBanner: {
      analyzing: (n: number) => `Round ${n} — Analysis in Progress`,
      analyzingDetail: "AI agent is evaluating the architect's corrections against the regulations.",
      completed: (n: number) => `Round ${n} — Review Completed`,
      completedDetail: "The compliance analysis for this round has finished. Review observations below.",
      correctionsReceived: (n: number) => `Round ${n} — Corrections Received`,
      correctionsDetail: "The architect submitted corrections for the previous round's observations. Analysis will start automatically.",
    },
    tabs: {
      resumen: "Summary",
  ...
  obs: {
    ...
    acceptNeedsReview: "Send observation",
    discardNeedsReview: "No",
    edit: "Edit",
    discard: "Discard",
...
const es: typeof en = {
  ...
  domDetail: {
    ...
    roundBanner: {
      analyzing: (n: number) => `Ronda ${n} — Análisis en curso`,
      analyzingDetail: "El agente IA está evaluando las correcciones del arquitecto contra la normativa.",
      completed: (n: number) => `Ronda ${n} — Revisión completada`,
      completedDetail: "El análisis de cumplimiento de esta ronda ha finalizado. Revisa las observaciones abajo.",
      correctionsReceived: (n: number) => `Ronda ${n} — Correcciones recibidas`,
      correctionsDetail: "El arquitecto envió correcciones a las observaciones de la ronda anterior. El análisis comenzará automáticamente.",
    },
    tabs: {
      resumen: "Resumen",
  ...
  obs: {
    ...
    acceptNeedsReview: "Enviar observación",
    discardNeedsReview: "No",
    edit: "Editar",
    discard: "Descartar",
