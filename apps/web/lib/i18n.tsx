...
const en = {
  ...
  dom: {
    ...
    correctionsRound: (n: number) => `Corrections R${n}`,
    newObsRound: (n: number) => `New obs. R${n}`,
    queries: "Queries",
    serverWaking: "The server is waking up — this takes about 30 seconds on first load.",
  },
  ...
  domDetail: {
    ...
    escalations: {
      empty: "No architect queries yet.",
      emptyDetail: "When the AI agent cannot answer with certainty, it will escalate the question here.",
      pending: "Pending",
      answered: "Answered",
      agentAttempt: "Agent attempt",
      escalationReason: "Escalation reason:",
      yourAnswer: "Your answer",
      yourAnswerLabel: "Your authoritative answer",
      answerPlaceholder: "Write your technical answer here...",
      saving: "Saving",
      reply: "Reply",
    },
    comparison: {
      ...
      retry: "Retry",
      oneRound: "Only one review round has been completed.",
      oneRoundDetail: "The comparison will be available after the architect submits a correction.",
    },
    analysis: {
      summary: {
  ...
  archDetail: {
    ...
    rejected: "Rejected",
    correctionLabels: {
      declared_constructibilidad: "floor area ratio",
      declared_ocupacion_suelo: "site coverage",
      declared_altura_m: "height",
      declared_densidad_hab_ha: "density",
      declared_estacionamientos: "parking",
      declared_distanciamiento_lateral_m: "side setback",
      declared_distanciamiento_fondo_m: "rear setback",
      declared_antejardin_m: "front setback",
      declared_superficie_total_edificada_m2: "built area",
    } as Record<string, string>,
    escalation: {
      domAnswered: "DOM answered your query",
      pendingOne: "1 query sent to DOM — awaiting response",
      pendingMany: (n: number) => `${n} queries sent to DOM — awaiting response`,
      escalatedToDom: "Escalated to DOM — awaiting response",
    },
    resubmitBanner: {
      analyzing: (round: number) => `Corrections received — Round ${round} in analysis`,
      analyzingDetail: "The system is automatically verifying your corrections. This takes ~50 seconds.",
      completed: (round: number) => `Round ${round} analysis completed`,
      completedDetail: "DOM will review the results and notify you of the outcome.",
    },
  },
  ...
  comparison: {
    params: {
      constructibilidad: "Floor Area Ratio",
      ocupacion_suelo: "Site Coverage",
      altura_maxima: "Maximum Height",
      densidad: "Density",
      estacionamientos: "Parking",
      distanciamiento_lateral: "Side Setback",
      distanciamiento_fondo: "Rear Setback",
      antejardin: "Front Setback",
      superficie_predio: "Plot Area",
      superficie_total_edificada: "Total Built Area",
      num_unidades_vivienda: "No. of Housing Units",
    } as Record<string, string>,
    status: {
      FIXED: "Remediated",
      PERSISTS: "Persists",
      NEW: "New observation",
      STILL_COMPLIANT: "Compliant",
    } as Record<string, string>,
    sections: {
      PERSISTS: "Persisting observations",
      NEW: "New observations",
      FIXED: "Remediated observations",
      STILL_COMPLIANT: "Compliant parameters in both rounds",
    } as Record<string, string>,
    roundRange: (r1: number, r2: number) => `Round ${r1} → ${r2}`,
    round: (n: number | string) => `Round ${n}`,
    declared: "Declared:",
    allowed: "Permitted:",
    delta: "Δ:",
    notAvailable: "The comparison is not available for this application.",
    availableAfterCorrections: "Will be available after the architect submits a correction (Round 2).",
  },

  // ── Admisibilidad pages ───────────────────────────────────────────────────────
  admisibilidad: {
    title: "Admissibility",
    subtitle: "DOM Las Condes — Admission Queue",
    backToReview: "Back to technical review",
    stats: {
      inQueue: "In queue",
      readyToAdmit: "Ready to admit",
      missingDocs: "With missing documents",
    },
    tableTitle: "Applications pending admission",
    loading: "Loading...",
    empty: "No applications pending admission.",
    col: {
    ...
    docStatus: {
      unanalyzed: "Not analyzed",
      analyzed: (met: number, total: number) => `${met}/${total} analyzed`,
      missing: (n: number) => `${n} missing`,
      complete: "Complete",
    },
    detail: {
      loadError: "Error loading the application.",
      analyzeError: "Error analyzing documents.",
      admitError: "Error admitting application.",
      loading: "Loading...",
      projectData: "Project Data",
      docsUploaded: "Documents uploaded",
      files: (n: number) => `${n} file${n !== 1 ? "s" : ""}`,
      noDocuments: "No attached documents yet.",
      checklistTitle: "Checklist Art. 5.1.6 OGUC",
      aiConfidence: "AI Confidence:",
      overriddenByReviewer: "Overridden by reviewer",
      pendingAnalysis: "Pending analysis",
      incompleteTitle: "Incomplete documentation",
      completeTitle: "Documentation complete",
      pendingVerification: "Pending verification",
      back: "Back",
      admit: "Admit application",
      admitting: "Admitting...",
  ...
  login: {
    dom: {
      branding: "DOM Las Condes",
      heading: "Building Permit Review System",
      description: "AI-assisted regulatory analysis platform for the Municipal Works Department of Las Condes, Chile.",
      features: [
        { label: "OGUC Verification", desc: "Automatic analysis against Art. 2.6.3 and land use table" },
        { label: "PRC Las Condes", desc: "Regulatory parameters by zone with semantic RAG" },
        { label: "Law 21.718 Deadlines", desc: "30/15 day tracking with automatic alerts" },
      ],
      footer: "Municipality of Las Condes · Municipal Works Department",
      signInHeading: "Sign in",
      signInSubtitle: "Use your institutional Google account to continue.",
      googleBtn: "Continue with Google",
      restricted: "Access is restricted to accounts authorized by DOM.",
      architectPrompt: "Are you an architect or property owner?",
      architectLink: "Access the architect portal",
    },
    architect: {
      branding: "Architect Portal",
      heading: "Submit your building permit online",
      description: "Digital platform for submitting and tracking building permit applications to DOM Las Condes.",
      features: [
        { label: "Digital submission", desc: "Upload your documents and AI extracts CIP parameters automatically" },
        { label: "Real-time tracking", desc: "Check your application status and receive Observation Reports" },
        { label: "AI Assistant", desc: "Resolve questions about observations, OGUC regulations, and corrections" },
      ],
      footer: "Municipality of Las Condes · Municipal Works Department",
      signInHeading: "Sign in",
      signInSubtitle: "Use your personal Google account to continue.",
      googleBtn: "Continue with Google",
      restricted: "Available for architects and property owners with active applications.",
      domPrompt: "Are you a DOM officer?",
      domLink: "Access the institutional system",
    },
  },
};
...
const es: typeof en = {
  ...
  dom: {
    ...
    correctionsRound: (n: number) => `Correcciones R${n}`,
    newObsRound: (n: number) => `Nueva obs. R${n}`,
    queries: "Consultas",
    serverWaking: "El servidor está iniciando — esto toma ~30 segundos en la primera carga.",
  },
  ...
  domDetail: {
    ...
    escalations: {
      empty: "Sin consultas del arquitecto aún.",
      emptyDetail: "Cuando el agente de IA no pueda responder con certeza, escalará la pregunta aquí.",
      pending: "Pendiente",
      answered: "Respondida",
      agentAttempt: "Intento del agente",
      escalationReason: "Motivo de escalación:",
      yourAnswer: "Tu respuesta",
      yourAnswerLabel: "Tu respuesta autoritativa",
      answerPlaceholder: "Escribe tu respuesta técnica aquí...",
      saving: "Guardando",
      reply: "Responder",
    },
    comparison: {
      ...
      retry: "Reintentar",
      oneRound: "Solo se ha completado una ronda de revisión.",
      oneRoundDetail: "La comparación estará disponible después de que el arquitecto presente una corrección.",
    },
    analysis: {
      summary: {
  ...
  archDetail: {
    ...
    escalation: {
      domAnswered: "El DOM respondió tu consulta",
      pendingOne: "1 consulta enviada al DOM — esperando respuesta",
      pendingMany: (n: number) => `${n} consultas enviadas al DOM — esperando respuesta`,
      escalatedToDom: "Escalado al DOM — esperando respuesta",
    },
    resubmitBanner: {
      analyzing: (round: number) => `Correcciones recibidas — Ronda ${round} en análisis`,
      analyzingDetail: "El sistema está verificando automáticamente tus correcciones. Esto toma ~50 segundos.",
      completed: (round: number) => `Análisis de Ronda ${round} completado`,
      completedDetail: "El DOM revisará los resultados y emitirá el acta correspondiente.",
    },
  },
  ...
  comparison: {
    ...
    status: {
      FIXED: "Subsanado",
      PERSISTS: "Persiste",
      NEW: "Nueva observación",
      STILL_COMPLIANT: "Conforme",
    } as Record<string, string>,
    sections: {
    ...
    roundRange: (r1: number, r2: number) => `Ronda ${r1} → ${r2}`,
    round: (n: number | string) => `Ronda ${n}`,
    declared: "Declarado:",
    allowed: "Permitido:",
    delta: "Δ:",
    notAvailable: "La comparación no está disponible para este expediente.",
    availableAfterCorrections: "Estará disponible después de que el arquitecto presente una corrección (Ronda 2).",
  },

  admisibilidad: {
    title: "Admisibilidad",
    subtitle: "DOM Las Condes — Cola de ingreso",
    backToReview: "Volver a revisión técnica",
    stats: {
      inQueue: "En cola",
      readyToAdmit: "Listos para admitir",
      missingDocs: "Con documentos faltantes",
    },
    tableTitle: "Expedientes pendientes de admisión",
    loading: "Cargando...",
    empty: "No hay expedientes pendientes de admisión.",
    col: {
      number: "N° Expediente",
      address: "Dirección",
      zone: "Zona",
    ...
    docStatus: {
      ...
      analyzed: (met: number, total: number) => `${met}/${total} analizados`,
      missing: (n: number) => `${n} faltante${n !== 1 ? "s" : ""}`,
      complete: "Completo",
    },
    detail: {
      loadError: "Error al cargar el expediente.",
      analyzeError: "Error al analizar documentos.",
      admitError: "Error al admitir expediente.",
      loading: "Cargando...",
      projectData: "Datos del proyecto",
      docsUploaded: "Documentos subidos",
      files: (n: number) => `${n} archivo${n !== 1 ? "s" : ""}`,
      noDocuments: "Sin documentos adjuntos aún.",
      checklistTitle: "Checklist Art. 5.1.6 OGUC",
      aiConfidence: "Confianza IA:",
      overriddenByReviewer: "Anulado por revisor",
      pendingAnalysis: "Pendiente de análisis",
      incompleteTitle: "Documentación incompleta",
      completeTitle: "Documentación completa",
      pendingVerification: "Pendiente de verificación",
      back: "Volver",
      admit: "Admitir expediente",
  ...
  login: {
    dom: {
      branding: "DOM Las Condes",
      heading: "Sistema de Revisión de Permisos de Edificación",
      description: "Plataforma de análisis normativo asistida por IA para la Dirección de Obras Municipales de Las Condes, Chile.",
      features: [
      ...
      footer: "Municipalidad de Las Condes · Dirección de Obras Municipales",
      signInHeading: "Acceder al sistema",
      signInSubtitle: "Usa tu cuenta institucional de Google para continuar.",
      googleBtn: "Continuar con Google",
      restricted: "El acceso está restringido a cuentas autorizadas por la DOM.",
      architectPrompt: "¿Eres arquitecto o propietario?",
      architectLink: "Accede al portal del arquitecto",
    },
    architect: {
      branding: "Portal del Arquitecto",
      heading: "Ingresa tu permiso de edificación en línea",
      description: "Plataforma digital de ingreso y seguimiento de permisos ante la DOM de Las Condes.",
      features: [
      ...
      footer: "Municipalidad de Las Condes · Dirección de Obras Municipales",
      signInHeading: "Acceder al portal",
      signInSubtitle: "Usa tu cuenta personal de Google para continuar.",
      googleBtn: "Continuar con Google",
      restricted: "Disponible para arquitectos y propietarios con expedientes activos.",
      domPrompt: "¿Eres funcionario DOM?",
      domLink: "Accede al sistema institucional",
    },
  },
};
